...
import { validateLogin, validatePasswordReset, validateUserDetails, handleValidationErrors } from '../middlewares/validator';

export default (router: express.Router) => {
  router.post('/auth/register', upload('project-manager').single('profileImage'), validateUserDetails, handleValidationErrors, Auth.register);
